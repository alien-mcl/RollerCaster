...
namespace Given_instance_of.MulticastObject_class
{
    ...
    public class when_adding_an_item_to_collection : MulticastObjectTest
    {
        ...
        {
            MulticastObject.SetProperty(typeof(IProduct).GetProperty(ExpectedProperty), "test");
        }
        ...
        {
            MulticastObject.SetProperty(typeof(IProduct).GetProperty(ExpectedProperty), new[] { "first" });
        }
    }
}
