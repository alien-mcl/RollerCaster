...
{
    [TestFixture]
    public class which_is_a_collection_with_no_elements : ScenarioTest<IProduct, ICollection<string>>
    {
        protected override string ExpectedPropertyName { get { return "Categories"; } }

        protected override ICollection<string> ExpectedValue { get { return new List<string>(); } }
